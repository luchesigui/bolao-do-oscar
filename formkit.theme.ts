 ...
 *
 * @checksum - c81728678e8934f2e5e66a46cf6a1186f802b8e7feb05b3262e79f3baeac18a7
 * @variables - radius=rounded-full,accentColor=yellow,colorTemperature=neutral,spacing=2,scale=base,inputShadow=shadow,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-[20em],tagRadius=rounded,swatchRadius=rounded
 * @theme - regenesis
 **/
...
const classes: Record<string, Record<string, boolean>> = {
  ...
  "family:text__input": {
    ...
    "group-data-[disabled]:!cursor-not-allowed": true,
    "dark:placeholder-neutral-400": true,
  ...
  submit__input: {
    ...
    "active:bg-yellow-600": true,
    "hover:border-yellow-500": true,
  ...
  togglebuttons__input: {
    ...
    "group-data-[vertical=false]/options:group-first/option:!rounded-full":
      true,
    ...
    "group-data-[vertical=false]/options:group-[]/option:aria-[pressed=true]:border-x-yellow-500":
      true,
    "group-data-[vertical=false]/options:group-first/option:aria-[pressed=true]:border-l-yellow-600":
      true,
    "group-data-[vertical=false]/options:group-last/option:aria-[pressed=true]:border-r-yellow-600":
      true,
    "dark:group-data-[vertical=false]/options:group-[]/option:aria-[pressed=true]:border-x-yellow-600":
      true,
    "dark:group-data-[vertical=false]/options:group-first/option:aria-[pressed=true]:border-l-yellow-600":
      true,
    "dark:group-data-[vertical=false]/options:group-last/option:aria-[pressed=true]:border-r-yellow-600":
      true,
    ...
    "group-data-[vertical=true]/options:group-[]/option:aria-[pressed=true]:border-y-yellow-500":
      true,
    "group-data-[vertical=true]/options:group-first/option:aria-[pressed=true]:border-t-yellow-600":
      true,
    "group-data-[vertical=true]/options:group-last/option:aria-[pressed=true]:border-b-yellow-600":
      true,
    "dark:group-data-[vertical=true]/options:group-[]/option:aria-[pressed=true]:border-y-yellow-600":
      true,
    "dark:group-data-[vertical=true]/options:group-first/option:aria-[pressed=true]:border-t-yellow-600":
      true,
    "dark:group-data-[vertical=true]/options:group-last/option:aria-[pressed=true]:border-b-yellow-600":
      true,
  },
  transferlist__outer: {
    group: true,
  ...
  "multi-step__tab": {
    ...
    'group-data-[tab-style="progress"]/wrapper:data-[valid=true]:data-[visited=true]:after:bg-yellow-600':
      true,
    ...
    'dark:group-data-[tab-style="progress"]/wrapper:data-[valid=true]:data-[visited=true]:after:bg-yellow-600':
      true,
  },
